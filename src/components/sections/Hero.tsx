...
// Time-reactive personality lines — the soul of DEAL
const modeLines: Record<string, string> = {
  health: 'Kitchen open. Macros dialled.',
  deal:   'Panini pressing. Grill on.',
  late:   'Still running. Night service on.',
  closed: 'Back at 07:00. Sleep well.',
};
    ...
    >
      ...
      <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between px-8 md:px-16 lg:px-24 pt-20 md:pt-0 gap-12 md:gap-0">
        <div className="flex flex-col">
          ...
          {/* Time-reactive soul line */}
          <motion.p
            key={mode}
            initial={{ opacity: 0, x: -6 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ delay: 1.05, duration: 0.35 }}
            className="font-mono text-offwhite/35 mb-8"
            style={{ fontSize: 'clamp(0.7rem, 1.4vw, 0.85rem)', letterSpacing: '0.05em' }}
          >
            ▸ {modeLines[mode]}
          </motion.p>
