    ...
    <div className="flex items-center gap-3 leading-none">
      ...
      >
        ...
        <path
          ...
          fill="#C9A96E"
        />
        {/* Tri-band accent — jade (dual identity) framed by red strokes (urgency / spice / late) */}
        <rect x="32" y="44.5" width="38" height="1.5" rx="1" fill="#D44332"/>
        <rect x="32" y="46"   width="38" height="8"   rx="1" fill="#4F9E6E"/>
        <rect x="32" y="54"   width="38" height="1.5" rx="1" fill="#D44332"/>
      </svg>
      ...
      <div className="flex flex-col gap-0.5">
        <span
          ...
          style={{ fontSize: titleSize, letterSpacing: '0.15em', lineHeight: 1 }}
        >
          D.E.A.L
        </span>
        <span
