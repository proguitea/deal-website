...
const vi: Translations = {
  ...
  contact: {
    ...
    recruitmentVn: 'DEAL – Realty Hub Coffee là quán cà phê cao cấp tại Tây Hồ, Hà Nội — mở cửa từ sáng sớm đến tận đêm khuya, phục vụ thực đơn lành mạnh ban ngày và ẩm thực fusion ban đêm, với không gian hiện đại mang phong cách công nghiệp ấm áp.',
  },
  footer: {
